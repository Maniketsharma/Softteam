...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MyViewHolder>{
    ...
    public  MessageAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return  new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.messageapter_layout,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull MessageAdapter.MyViewHolder myViewHolder, int position) {
        MessageList message = messageLists.get(position);
