...
// Create and set adapter
        MessageAdapter messageAdapter = new MessageAdapter(messageLists, MainActivity.this);
...
// Initialize and show ProgressDialog
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
               final String profile = snapshot.child("users").child(number).child("profile_pic").getValue(String.class);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                   ...
                   MessageList messageList = new MessageList(getName, getMobile, "", getProfile,unseen);
                    ...
                    if (getMobile.equals(number)) {
                        ...
                        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (!dataset) {
                                    MessageList messageList = new MessageList(getName, getMobile, last, getProfilePic, unseen);
                                    messageLists.add(messageList);
